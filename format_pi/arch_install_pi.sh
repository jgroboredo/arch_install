...
function pacstrapping() {
    ...
    KEYRING_PKG="archlinuxarm-keyring-20140119-1-any.pkg.tar.xz"
...
function bootloader(){
    ...
    KERNEL_OPTS="$KERNEL_OPTS rootflags=subvol=\/@ cgroup_enable=cpuset cgroup_enable=memory cgroup_memory=1 swapaccount=1 reboot=pci"
